  ...
  <body>
    <div class="maincont">
     ...
     <ul class="userNav">
      ...
      <li><span class="glyphicon glyphicon-usd"></span><a href="quan">我的优惠券</a></li>
      <li><span class="glyphicon glyphicon-map-marker"></span><a href="address">收货地址管理</a></li>
      <li><span class="glyphicon glyphicon-star-empty"></span><a href="/user/save">我的收藏</a></li>
      <li><span class="glyphicon glyphicon-heart"></span><a href="/user/history">我的浏览记录</a></li>
      <li><span class="glyphicon glyphicon-usd"></span><a href="/user/withdraw">余额提现</a></li>
	 </ul><!--userNav/-->
